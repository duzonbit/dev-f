...
const GET_POST_LIST_PENDING = 'list/GET_POST_LIST_PENDING'; //요청시작
const GET_POST_LIST_SUCCESS = 'list/GET_POST_LIST_SUCCESS'; //요청성공
const GET_POST_LIST_FAILURE = 'list/GET_POST_LIST_FAILURE'; //요청 실패
